    ...
    <div>
      ...
      <div className="mt-56 m-10">
        <div className="text-center text-5xl uppercase relative ">
          ...
          <p
            className="font-black absolute text-center w-full text-gray-50 "
            style={{
              zIndex: -100,
              top: -10,
              fontSize: "10rem",
        ...
        <div className="grid lg:grid-cols-2 sm:grid-cols-1 gap-4 mt-36">
          <div className="m-10 p-10 rounded-3xl font-bold shadow-sm bg-gradient-to-r from-gray-50  to-gray-100 ">
          ...
          <div className="bg-gradient-to-r from-gray-50  to-gray-100 m-10 p-10 rounded-3xl font-bold shadow-sm">
        ...
        <div className="text-center flex flex-col justify-center items-center mt-40">
          ...
          <div className="flex flex-col w-1/2 mt-10 items-center">
            <input
              type="text"
              name="name"
              id="name"
